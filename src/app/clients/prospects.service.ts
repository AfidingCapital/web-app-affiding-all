...
export class ProspectsService {
   ...
   */
 private base = 'http://172.26.176.1:8080//custom-provider/api/v1'
  ...
  getFilteredClients(
    ...
    return this.http.get(`${this.base}/prospects`, { params: httpParams });
  }
  ...
  getDraftClients(): Observable<any> {
    const httpParams = new HttpParams().set('status', 'Prospects');
    return this.http.get(`${this.base}/prospects`, { params: httpParams });
  }
