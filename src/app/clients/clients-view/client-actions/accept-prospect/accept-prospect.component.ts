 ...
 */
@Component({
  selector: 'mifosx-accept-prospect',
  templateUrl: './accept-prospect.component.html',
  styleUrls: ['./accept-prospect.component.scss']
})
export class AcceptProspectComponent implements OnInit {
